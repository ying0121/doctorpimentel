...
<head>
    ...
    <style>
        ...
        #letters_table tbody tr td:first {
                                                            ...
                                                            <div class="w-100 text-center d-flex justify-content-center align-items-center <?php if ($letters[$i]["status"] == 0) echo "bg-inactive"; ?>" style="min-height: 80px;">
                                                                <div class="mb-2" data-id="<?php echo $letters[$i]['id'] ?>">
                                                                    ...
                                                                    <div class="d-flex justify-content-center align-items-center">
                                                                        <a href="javascript:;" class="text-primary letter_request" style="font-size: 18px;" data-id="<?php echo $letters[$i]['id']; ?>" data-title="<?php echo $letters[$i]['title'] ?>"><?php echo $component_text['t_request'] ?></a>
                                                                        &nbsp;&nbsp;|&nbsp;&nbsp;
                                                                        <a href="<?php echo base_url(); ?>letters/detail?s=<?php echo $letters[$i]['id'] ?>" target="_blank" style="font-size: 18px;"><?php echo $component_text['btn_info']; ?></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
