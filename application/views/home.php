                                            ...
                                            <div id="contact_form">
                                                ...
                                                <form class="w-100 content-form wow fadeInUp" id="appointment_form" action="#" method="post" accept-charset="utf-8" novalidate="novalidate" style="visibility: visible; animation-name: fadeInUp;">
                                                    <div style="text-align: left;">
                                                        ...
                                                        <input type="radio" value="2" class="contactusertype ml-3" name="contactusertype"><span style="font-size:18px; color:white; "> <?php echo $component_text['t_contact_option_business'] ?></span><br>
                                                        <div style="font-size:18px; color:white; margin:10px;"><?php echo $component_text['this_is_about'] ?></div>
                                                        ...
                                                        <input type="radio" value="2" class="contactpttype-patient ml-3" name="contactpttype"><span class="contactpttype-patient" style="font-size:18px; color:white; "> <?php echo $component_text['t_contact_option_new'] ?></span>
                                                        ...
                                                        <input type="radio" value="4" class="contactpttype-institution ml-3" name="contactpttype"><span class="contactpttype-institution" style="font-size:18px; color:white; "> <?php echo $component_text['t_contact_option_generalmsg'] ?></span><br>
