...
<body class="counter-scroll header_sticky bg-gray">
                    ...
                    <div id="site-content" class="site-content clearfix">
                        <div id="inner-content" class="inner-content-wrap">
                            <div class="page-content">
                                <section class="box-letter-details">
                                    <div class="letter-container">
                                        <div class="d-flex justify-content-start align-items-center">
                                            <div class="row">
                                                <div class="col-md-12 px-0">
                                                    <p class="letter-title d-flex justify-content-start align-items-center mb-5 px-p7"><?php echo $letter['title'] ?></p>
                                                </div>
                                                <div class="col-md-12 d-flex justify-content-start p-0 mb-2">
                                                    <i class="fa fa-<?php echo $letter['icon']; ?>" style="font-size: 180px;"></i>
                                                    <div class="mx-5">
                                                        <div class="d-flex justify-content-start align-items-center mb-5">
                                                            <button class="btn btn-lg btn-submit" id="request_letter" data-title="<?php echo $letters[$i]['title'] ?>"><?php echo $component_text['t_request']; ?></button>
                                                        </div>
                                                ...
                                                <div class="col-md-12 px-0">
                                                    <div class="letter-desc text-black"><?php echo $letter['short_desc'] ?></div>
                                                    <div class="letter-desc text-black"><?php echo $letter['long_desc'] ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal modal-fade scroll-y" tabindex="-1" role="dialog" aria-hidden="true" id="letter_request_modal">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <input type="hidden" id="letter_name" />
                <div class="modal-header py-3">
                    <h3 style="font-size: 24px;" id="letter_title"><?php echo $component_text['t_request_letter'] ?></h3>
                </div>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12 d-none" id="letters_opt_moreinfo">
                            <p><?php echo $component_text['t_opt_in_out_more']; ?></p>
                        </div>
                        <div class="col-12 mb-3 pt-0">
                            <a href="#" id="letters_opt_more_info_btn"><?php echo $component_text['t_opt_more_info']; ?> >></a>
                        </div>
...
<script>
    let _selected_letter_id = "<?php echo $letter['id']; ?>";
    let _selected_letter_title = "";
    let _selected_letter_cost = 0;
    $(document).ready(function() {
        // request letter
        $("#request_letter").click(function() {
            _selected_letter_title = $(".letter-title").text()
            $.ajax({
        ...
        $("#letter_request_modal_close").click(function() {
            $("#letter_request_modal").css({
                'display': 'none'
            })
        })
