...
class Vault extends CI_Controller
{
    ...
    public function submitContact()
    {
        ...
        $tmpsubject = 'Case #: ' . $case_number . $acronym . ' ' . $data['reason'] . " - Email From General Medical Services of Queens";
    ...
    public function addMessage()
    {
        ...
        $tmpsubject = "CASE #: " . $case_number . $acronym . " " . $contact['reason'] . " - Email From General Medical Services of Queens";
