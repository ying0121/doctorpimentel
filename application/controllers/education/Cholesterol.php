...
class Cholesterol extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->session->set_userdata("page_status", "education/Cholesterol");
    }
    ...
    public function index()
    {
        ...
        $data['docs'] = $this->Education_model->getDocs($siteLang, "cholesterol");

        $this->load->view('education/cholesterol', $data);
    }
