...
class TobaccoTreatment extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->session->set_userdata("page_status", "education/TobaccoTreatment");
    }
    ...
    public function index()
    {
        ...
        $data['docs'] = $this->Education_model->getDocs($siteLang, "tobacco_treatment");

        $this->load->view('education/tobacco_treatment', $data);
    }
