...
class PulmonaryDisease extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->session->set_userdata("page_status", "education/PulmonaryDisease");
    }
    ...
    public function index()
    {
        ...
        $data['documents'] = $this->Frontend_model->getPageDocuments($siteLang, 'Orientation');
        ...
        $data['docs'] = $this->Education_model->getDocs($siteLang, "pulmonary_disease");

        $this->load->view('education/pulmonary_disease', $data);
    }
