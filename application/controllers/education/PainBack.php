...
class PainBack extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->session->set_userdata("page_status", "education/PainBack");
    }
    ...
    public function index()
    {
        ...
        $data['docs'] = $this->Education_model->getDocs($siteLang, "pain_back");

        $this->load->view('education/pain_back', $data);
    }
