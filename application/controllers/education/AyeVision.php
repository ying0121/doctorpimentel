...
class AyeVision extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->session->set_userdata("page_status", "education/AyeVision");
    }
    ...
    public function index()
    {
        ...
        $data['docs'] = $this->Education_model->getDocs($siteLang, "aye_and_vision");

        $this->load->view('education/aye_vision', $data);
    }
