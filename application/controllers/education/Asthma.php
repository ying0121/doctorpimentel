...
class Asthma extends CI_Controller
{
    ...
    public function index()
    {
        ...
        //education
        $data['videos'] = $this->Education_model->getVideos($siteLang, "asthma");
        $data['docs'] = $this->Education_model->getDocs($siteLang, "asthma");

        $this->load->view('education/asthma', $data);
    }
