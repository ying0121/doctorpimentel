...
class Nutrition extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->session->set_userdata("page_status", "education/Nutrition");
    }
    ...
    public function index()
    {
        ...
        $data['docs'] = $this->Education_model->getDocs($siteLang, "nutrition");

        $this->load->view('education/nutrition', $data);
    }
