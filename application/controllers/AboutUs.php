...
class AboutUs extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['HEADER_BANNER'] = $this->Frontend_model->getPageImages('AboutUs', 'HEADER-BANNER', $siteLang);
        $data['CENTRAL'] = $this->Frontend_model->getPageImages('AboutUs', 'CENTRAL', $siteLang);
        $data['qualities'] = $this->Frontend_model->getMeasureValue($siteLang);
        ...
        $this->session->set_userdata("page_status", "aboutus");
