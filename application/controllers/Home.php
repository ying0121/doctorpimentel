...
class Home extends CI_Controller
{
    ...
    public function submit()
    {
        ...
        if ($this->session->userdata('ying') == md5($captcha . '.png')) {
            ...
            $tmpsubject = "CASE #: " . $result["case_number"] . $acronym . " " . $reason . " - Email From General Medical Services of Queens";
        ...
        if ($this->session->userdata('ying-footer') == md5($captcha . '.png')) {
            ...
            if ($data['fname'] == '' || $data['lname'] == '' || $data['email'] == '') {
                ...
                if ($result['message'] == 'success') {
                    ...
                    $this->email->subject('Case #: ' . $mail_body['id'] . $acronym . ' doctorpimentel.com - PT Area Account Request');
