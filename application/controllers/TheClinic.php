...
class TheClinic extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['HEADER_BANNER'] = $this->Frontend_model->getPageImages('TheClinic', 'HEADER-BANNER', $siteLang);
        ...
        $this->session->set_userdata("page_status", "theclinic");

        $this->load->view('theclinic', $data);
    }
